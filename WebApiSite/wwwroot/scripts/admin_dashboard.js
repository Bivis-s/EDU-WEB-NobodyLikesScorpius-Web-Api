...
async function getIsAdminAuthorized(sessionToken) {
    let apiResponse = await fetch("http://168.63.68.254:3505/IsAdminAuthorized?sessionToken=" + sessionToken);
    if (apiResponse.ok) {
...
async function updatePredictionInDb() {
    ...
    await fetch("http://168.63.68.254:3505/UpdatePrediction",
        {
            method: 'POST',
            headers: {
...
function updateGoToHoroscopeButton(zodiacNumber, timeIntervalNumber) {
    $("#goToHoroscopeButton").attr("href", "http://168.63.68.254:3505/pages/prediction.html?type=" + zodiacNumber + "&time=" + timeIntervalNumber);
}
...
async function updateCompatibilityInDb() {
    ...
    await fetch("http://168.63.68.254:3505/UpdateCompatibility",
        {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json'
