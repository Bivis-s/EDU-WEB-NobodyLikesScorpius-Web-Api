...
getZodiacs().then((haircuts) => {
    ...
    haircuts.forEach((haircut) => {
        haircutRows += "<tr>" +
            "<td><b>" + haircutPredictionDate.getDate() + "</b> " + getMonthNameByDate(haircutPredictionDate) + "<br>" + getDayOFWeekNameByDate(haircutPredictionDate) + "</td>" +
